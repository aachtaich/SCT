...
class StateConstraintTransitionServlet extends XtextServlet {
	...
	override init() {
		...
		new StateConstraintTransitionWebSetup(executorServiceProvider).createInjectorAndDoEMFRegistration()
	}
