...
import org.xtext.example.stateconstrainttransition.web.StateConstraintTransitionWebSetup;
...
public class StateConstraintTransitionServlet extends XtextServlet {
  ...
  public void init() {
    try {
      ...
      StateConstraintTransitionWebSetup _stateConstraintTransitionWebSetup = new StateConstraintTransitionWebSetup(executorServiceProvider);
      _stateConstraintTransitionWebSetup.createInjectorAndDoEMFRegistration();
    } catch (Throwable _e) {
